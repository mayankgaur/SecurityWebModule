...
/****** Object:  Database [SecurityDB]    Script Date: 01-09-2018 09:11:33 ******/
...
CREATE DATABASE [SecurityDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SecurityDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\SecurityDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'SecurityDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\SecurityDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [SecurityDB] SET COMPATIBILITY_LEVEL = 140
GO
